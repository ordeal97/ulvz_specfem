...
- `packages/ulvz_stf_convolution/`: standalone ASCII/SAC post-run
  source-time-function convolution package; start with its
  [中文 README](packages/ulvz_stf_convolution/README.md).
