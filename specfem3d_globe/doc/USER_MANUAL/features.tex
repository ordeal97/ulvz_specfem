\chapter*{Simulation features supported in SPECFEM3D Globe}
\addcontentsline{toc}{chapter}{Simulation features supported in SPECFEM3D Globe}

The following lists all available features for a SPECFEM3D Globe simulation,
