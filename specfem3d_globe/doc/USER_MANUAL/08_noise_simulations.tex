...
The new version of SPECFEM3D Globe includes functionality for seismic noise tomography.
...
New to this version of SPECFEM3D Globe, a parameter called \texttt{NOISE\_TOMOGRAPHY} has been added that specifies the type of simulation to be run.
...
\texttt{NSTEP} and \texttt{dt} have been given when compiling the SPECFEM3D Globe source code;
...
./NOISE_TOMOGRAPHY/ in the SPECFEM3D Globe package
\end{verbatim}
...
\item
Create a new directory in the SPECFEM3D Globe package, name it as \texttt{NOISE\_TOMOGRAPHY}.
...
That's to say, you will have a file \texttt{NOISE\_TOMOGRAPHY/S\_squared} in the SPECFEM3D Globe package.
