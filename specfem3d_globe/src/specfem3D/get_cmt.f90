...
!
  ...
  do isource = 1,NSOURCES
    ...
    ipos = index(string,':')
    if (ipos > 1 .and. ipos < len_trim(string)) then
      read(string(ipos+1:len_trim(string)),*) moment_tensor(1,isource)
    else
    ...
    ipos = index(string,':')
    if (ipos > 1 .and. ipos < len_trim(string)) then
      read(string(ipos+1:len_trim(string)),*) moment_tensor(2,isource)
    else
    ...
    ipos = index(string,':')
    if (ipos > 1 .and. ipos < len_trim(string)) then
      read(string(ipos+1:len_trim(string)),*) moment_tensor(3,isource)
    else
    ...
    ipos = index(string,':')
    if (ipos > 1 .and. ipos < len_trim(string)) then
      read(string(ipos+1:len_trim(string)),*) moment_tensor(4,isource)
    else
    ...
    ipos = index(string,':')
    if (ipos > 1 .and. ipos < len_trim(string)) then
      read(string(ipos+1:len_trim(string)),*) moment_tensor(5,isource)
    else
    ...
    ipos = index(string,':')
    if (ipos > 1 .and. ipos < len_trim(string)) then
      read(string(ipos+1:len_trim(string)),*) moment_tensor(6,isource)
    else
