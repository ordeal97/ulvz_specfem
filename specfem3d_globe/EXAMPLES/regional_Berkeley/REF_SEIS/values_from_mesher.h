 ...
 !
 ! maximum number of points per region =       368037
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =      1104111
 !
 ! total elements per slice =         5985
 ! total points per slice =       404967
 !
 ...
 !
 ! size of static arrays per slice =    232.70914400000001       MB
 !                                 =    221.92873382568359       MiB
 !                                 =   0.23270914400000001       GB
 !                                 =   0.21672727912664413       GiB
 !
 ...
 !
 ! size of static arrays for all slices =    930.83657600000004       MB
 !                                      =    887.71493530273438       MiB
 !                                      =   0.93083657600000003       GB
 !                                      =   0.86690911650657654       GiB
 !                                      =    9.3083657599999997E-004  TB
 !                                      =    8.4659093408845365E-004  TiB
 !

 integer, parameter :: NEX_XI_VAL =           48
 integer, parameter :: NEX_ETA_VAL =           48

 integer, parameter :: NSPEC_CRUST_MANTLE =         5472
 ...
 integer, parameter :: NGLOB_CRUST_MANTLE =       368037
 ...
 integer, parameter :: NSPECMAX_ISO_MANTLE =         5472
 integer, parameter :: NSPECMAX_TISO_MANTLE =         5472
 integer, parameter :: NSPECMAX_ANISO_MANTLE =            0

 integer, parameter :: NSPEC_CRUST_MANTLE_ATTENUATION =         5472
 integer, parameter :: NSPEC_INNER_CORE_ATTENUATION =           27

 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =         5472
 ...
 integer, parameter :: NSPEC_CRUST_MANTLE_STACEY =         5472
 integer, parameter :: NSPEC_OUTER_CORE_STACEY =          486

 integer, parameter :: NGLOB_CRUST_MANTLE_OCEANS =       368037
 ...
 integer, parameter :: NX_BATHY_VAL =          360
 integer, parameter :: NY_BATHY_VAL =          181
 ...
 integer, parameter :: ATT4_VAL =         5472
 ...
 integer, parameter :: NGLOB_XY_CM =       368037
 ...
 integer, parameter :: NT_DUMP_ATTENUATION_VAL =          703
